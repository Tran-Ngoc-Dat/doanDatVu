                                ...
                                <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                    <div class="tab-pane fade show active" id="tabs-lang-vi" role="tabpanel"
                                                ...
                                                <label class="upload-file-label mb-2" for="file_attach">
                                                    <div class="custom-file my-custom-file">
                                                        <input type="file" class="custom-file-input" name="file_attach"
                                                            id="file_attach" lang="vi">
                                                        <label class="custom-file-label mb-0" data-browse="Chọn"
                                                            for="file_attach">Chọn file</label>
                                                    </div>
                                                </label>
                                                <strong
                                                    class="d-block text-sm mb-3"><?=$config['news'][$type]['file_type']?></strong>
                                                <?php if(isset($item['file_attach']) && $item['file_attach'] != '') { ?>
                                                <span
                                                    class="alert d-block alert-primary"><?=$item['file_attach']?></span>
                                                <?php } ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control for-seo text-sm " name="data[description]"
                                                id="description" rows="5"
                                                placeholder="Mô tả"><?= htmlspecialchars_decode($flash->get('description')) ?: htmlspecialchars_decode(@$item['description']) ?></textarea>
                                        </div>
                                        <?php } ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control for-seo text-sm form-control-ckeditor"
                                                ...
                                                placeholder="Nội dung"><?= htmlspecialchars_decode($flash->get('content')) ?: htmlspecialchars_decode(@$item['content']) ?></textarea>
                                        </div>
                                        <?php } ?>
                                    </div>
                                </div>
