...
<a class="my-info-box info-box" href="index.php?source=setting&act=update" title="Cấu hình website">
    ...
    <div class="info-box-content text-dark">
        ...
        <span class="info-box-number">View more</span>
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <a class="my-info-box info-box" href="index.php?source=user&act=info_admin" title="Tài khoản">
            ...
            <div class="col-12 col-sm-6 col-md-3">
                <a class="my-info-box info-box" href="index.php?source=user&act=info_admin&changepass=1" title="Đổi mật khẩu">
