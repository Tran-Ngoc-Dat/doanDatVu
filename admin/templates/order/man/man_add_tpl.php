...
<section class="content">
	<form method="post" novalidate action="<?= $linkSave ?>" enctype="multipart/form-data">
		...
		<div class="card card-primary card-outline text-sm">
			...
			<div class="card-body row">
				...
				<div class="form-group col-12">
					...
					<textarea class="form-control text-sm" name="" id="" rows="5" placeholder="Ghi chú"><?= @$item['notes'] ?></textarea>
				</div>
			</div>
		</div>
		<div class="card card-primary card-outline text-sm">
