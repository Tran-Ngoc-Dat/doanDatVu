        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    ...
                    <p class="info-box-text text-sm mb-0">Tổng giá: <span
                            class="text-danger font-weight-bold"><?=$func->formatMoney($totalConfirmOrder)?></span></p>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
                ...
                <div class="info-box-content">
                    ...
                    <p class="info-box-text text-sm mb-0">Tổng giá: <span
                            class="text-danger font-weight-bold"><?=$func->formatMoney($totalCanceledOrder)?></span></p>
                </div>
            </div>
        </div>
    </div>
    <div class="card-footer text-sm sticky-top">
        <div class="form-inline form-search d-inline-block align-middle mr-3" style="width:30%">
        ...
        <select name="" id="select-order" class="select-order select2 w-50">
            <option value="">Quản lý đơn hàng</option>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="align-middle">
                            <?php
                                        if(isset($items[$i]['order_status']) && $items[$i]['order_status'] == 1)
                                        {
                                            ...
                                            ?>
                            <span class="info-box-text text-primary font-weight-bold text-capitalize text-sm">Mới
                                đặt</span>
                            <?php } ?>
                            <?php
                            ...
                            <?php
                                        if(isset($items[$i]['order_status']) && $items[$i]['order_status'] == 3)
                                        {
                                            ...
                                            //$order_status = $d->rawQueryOne("select namevi, class_order from #_order_status where id = ?",array($id_order_status));
                                            ?>
                            <span class="info-box-text text-success font-weight-bold text-capitalize text-sm">Đã
                                giao</span>
                            <?php } ?>
                            <?php
                                        if(isset($items[$i]['order_status']) && $items[$i]['order_status'] == 4)
                                        {
                                            $id_order_status = $items[$i]['order_status'];
                                            //$order_status = $d->rawQueryOne("select namevi, class_order from #_order_status where id = ?",array($id_order_status));
                                            ?>
                            <span class="info-box-text text-danger font-weight-bold text-capitalize text-sm">Đã
                                hủy</span>
                            <?php } ?>
                            <span
                        ...
                        <td class="align-middle text-center text-lg text-nowrap">
                            ...
                            <a class="text-primary mr-2" href="index.php?source=excel&id=<?=$items[$i]['id']?>"
                                title="Xuất file excel"><i class="far fa-file-excel"></i></a>
                            <?php } ?>
                            <?php if(isset($config['order']['word']) && $config['order']['word'] == true) { ?>
                            <a class="text-primary" href="index.php?source=word&id=<?=$items[$i]['id']?>"
